...
class PoissonSolver  {
    public:
        ...
        void BuildLocalMatrices (double* A_loc, double* B_loc,double* mult_3,int size_,int ldAgb,int Nx,int Ny,double one_dx2,double one_dy2,double two_dxdy,int* ipiv,int KL,int KU
