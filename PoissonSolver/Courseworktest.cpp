...
int main () {
    ...
    */
    ...
    double *B_row=new double[ldB*nsv];
    
    FillGBmatrix_1stDerCentral_col(B_col,ldB,nsv,Ny,one_2dy);
    cout<<"General Banded matrix for first der central scheme: "<<endl;
    print_matrix(B_col,ldB,nsv);
    FillGBmatrix_1stDerCentral_row(B_row,ldB,nsv,Nx,one_2dx);
